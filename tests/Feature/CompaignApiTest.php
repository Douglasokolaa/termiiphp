...
test('it can get phonebooks', closure: function () {
    expect(\Okolaa\TermiiPHP\Requests\Campaign\Phonebook\GetPhonebooksRequest::class)
        ->toSendGetRequest()
...
test('it can create a phonebook', closure: function () {
    expect(\Okolaa\TermiiPHP\Requests\Campaign\Phonebook\CreatePhonebookRequest::class)
        ->toSendPostRequest()
