...
class Termii
{
     ...
     * @return array
     */
    public function sendToken(array $payload)
    {
        $data = array_merge(
            $this->payload(),
            [
     ...
     * @return array
     */
    public function verifyToken(array $payload)
    {
        $data = array_merge(
            $this->payload(),
            [
     ...
     * @return array
     */
    public function InAppToken(array $payload)
    {
        $data = array_merge(
            $this->payload(),
            [
     ...
     * @return array
     */
    public function sendWithAutoGeneratedNumber(array $payload)
    {
        $data = array_merge(
            $this->payload(),
            [
    ...
    /**
     * Sets Channel to Send Message Via
     *
     ...
     * @return $this
     */
    public function SetPinLength(int $pinLength)
    {
